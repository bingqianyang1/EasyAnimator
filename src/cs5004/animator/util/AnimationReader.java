...
public class AnimationReader {
  ...
  /**
   * Reads the information of the canvas.
   * @param s the Scanner class
   * @param builder the AnimationBuilder object
   * @param <Doc> the actual type we'll use
   */
  ...
  /**
   * Reads the information of the shape.
   * @param s the Scanner class
   * @param builder the AnimationBuilder object
   * @param <Doc> the actual type we'll use
   */
  ...
  /**
   * Reads the motion of the animation.
   * @param s the Scanner class
   * @param builder the AnimationBuilder object
   * @param <Doc> the actual type we'll use
   */
  ...
  /**
   * This is for getting integer from reading the content.
   * @param s the Scanner object
   * @param label the label
   * @param fieldName the name of file
   * @return integer
   */
